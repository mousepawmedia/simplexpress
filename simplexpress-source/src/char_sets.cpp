    ...
    bool char_sets::digit(onechar ch, int radix)
    {
        ...
        else if(radix == 12)
        {
            ...
            else
            {
                ...
                //FIXME: not Unicode compatible - this is a hack to get to a compile.
                //NOTE: and will always fail on non-Latin sets - need actual unicode mapping
                char upper_ch = toupper(ch.c_str()[0]);
